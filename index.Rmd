...
subtitle: "Have you seen<br>a hacker with <br>a mouse 🖱️"
output: 
...
workshop_day <- format(as.Date("2025-03-01"), format="%B %d %Y")
...
.rightcol60[
+ Postdoc at Centre for Consciousness Studies, NIMHANS, India

+ Building a bridge between `squishy neurons` and `deep existential feels`

+ I love teaching and mentoring
]
